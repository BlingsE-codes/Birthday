...
displayimage = document.getElementById("displaymessage");
image = document.getElementById(`wifyimage`);
...
function updateCountdown() {
    ...
    const celebrantname = document.getElementById("name-input").value;
